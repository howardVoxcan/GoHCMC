"""
Django settings for GoSaiGon project.
...
ROOT_URLCONF = 'GoSaiGon.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / 'location/templates',
            os.path.join(BASE_DIR, 'templates'),  # Thư mục templates toàn cục
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'GoSaiGon.wsgi.application'
